  ...
  function ControllerViewModel() {
    ...
    var navData = [
      ...
      },
      {
        ...
        id: "formularios",
        iconClass:
          "oj-navigationlist-item-icon demo-icon-font-24 demo-library-icon-24",
      },
      {
        name: "Dashboard",
        id: "dashboard",
      ...
      // { name: "Getting Started", id: "incidents", iconClass: "oj-navigationlist-item-icon demo-icon-font-24 demo-education-icon-24" },
      // { name: "Cookbook", id: "customers", iconClass: "oj-icon oj-icon-xs book-icon" },
      // { name: "Style Lab", disabled: "true", id: "about", iconClass: "oj-navigationlist-item-icon demo-icon-font-24 demo-palette-icon-24" },
      // { name: "Support", id: "support", iconClass: "oj-navigationlist-item-icon demo-icon-font-24 demo-chat-icon-24" },
      // { name: "Contact us", id: "contactus", iconClass: "oj-ux-ico-contact" },
    ];
